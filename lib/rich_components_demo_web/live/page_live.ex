defmodule RichComponentsDemoWeb.PageLive do
  ...
  alias RichComponentsDemoWeb.Components.{TextEditor, SelectSector, MultiSelectSector}

  defmodule FakeForm do
    defstruct [:message_text, :industry_code, :industry_codes]
  end
  ...
  def mount(_params, _session, socket) do
    ...
    types = %{industry_code: :string, industry_codes: {:array, :string}, message_text: :string}
    ...
    changeset =
      ...
      |> Ecto.Changeset.cast(
        %{
          industry_code: "451030",
          message_text: "",
          industry_codes: ["252030", "352030", "252020"]
        },
        [
          :industry_code,
          :industry_codes,
    ...
    <div class="container m-auto p-20">
      ...
      <div class="shadow-2xl border-0 p-3">
        ...
        >
          ...
          <div class="prose mt-7 mb-2">
            <h3 class="m-auto">Multi Select</h3>
          </div>

          <MultiSelectSector id="multi-select-sector" name={:industry_codes} />
