...
config :rich_components_demo, RichComponentsDemoWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "UScJVo6fLac75Aai3aSWtjAXawgdWKme1ABzIHjGaRr6vL1nFbY6IeKW7PEFPyZE",
  ...
  live_view: [signing_salt: "bod/gTtC"]
...
config :rich_components_demo, RichComponentsDemo.Mailer, adapter: Swoosh.Adapters.Local
